            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <img src="<?php echo base_url() ?>logo5.png" class="img2">
                    ...
                    <div class="col-sm-6 hidden-xs">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <input type="button" value="login" class="button3">
                                </div>
                            </div>
                        </div>	
                    </div>
                            ...
                            <div class="well8">
                                ...
                                <form class="form-horizontal">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="textinput" align="left">{{x}}</label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="row">
                                            <div class="col-md-7">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">	  
                                                        <img src="<?php echo base_url() ?>1.jpg" class="img-circle" alt="Cinque Terre" width="100" height="100"> 
                                                        <div class="caption">
